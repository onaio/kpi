        ...
        <bem.FormModal__item m='wrapper'>
          ...
          <bem.FormModal__item m='metadata-share'>
            <Checkbox
              ...
              label={t('Help ONA improve this product by sharing the sector and country where this project will be deployed.') + ' ' + t('All the information is submitted anonymously, and will not include the project name or description listed above.')}
            />
          </bem.FormModal__item>
